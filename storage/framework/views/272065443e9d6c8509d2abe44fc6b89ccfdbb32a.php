...
<div class="row">
    <div class="col-lg-12">
        ...
        <div class="card mb-3">
            ...
            <div class="card-body">
                <button onclick="location.href='<?php echo URL::to('/'); ?>/manageOnlineCourse/availableClass/manageOnlineClass/<?php echo $idCoursesClass; ?>/manageSession/<?php echo $idTopic; ?>/<?php echo $idSubTopic; ?>/manageExam/<?php echo $idExam; ?>/upload/evaluateExam'" class="btn btn-warning">Back</button>&nbsp;
                <br />
                <br />
                                ...
                                <td>
                                    <?php if($getExamCompletion->isEvaluated == "0"): ?>
                                        <?php if($getStudentAnswer->isScored == '0'): ?>
                                            <form method="post" action="<?php echo URL::to('/'); ?>/manageOnlineCourse/availableClass/manageOnlineClass/<?php echo $idCoursesClass; ?>/manageSession/<?php echo $idTopic; ?>/<?php echo $idSubTopic; ?>/manageExam/<?php echo $idExam; ?>/upload/evaluateExam/<?php echo $idMember; ?>/submitEvaluate" class="form-horizontal">
...
<script language="JavaScript">
    function finishEvaluation(){
        ...
        if(isConfirm){
            location.href="<?php echo URL::to('/'); ?>/manageOnlineCourse/availableClass/manageOnlineClass/<?php echo $idCoursesClass; ?>/manageSession/<?php echo $idTopic; ?>/<?php echo $idSubTopic; ?>/manageExam/<?php echo $idExam; ?>/upload/evaluateExam/<?php echo $idMember; ?>/finishEvaluation";
        }
    }
</script>
