    ...
    <div class="col-lg-12">
        ...
        <div class="card mb-3">
            <div class="card-header bg-success">
                <i class="fa fa-user-circle-o"></i> Exams List</div>
            <div class="card-body">
                ...
                <table class="table table-hovered">
                    ...
                    <?php else: ?>
                        <?php $__currentLoopData = $dataExam; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            ...
                            $getExamCompletion = $db->getExamCompletionByIdExamAndIdMember($data->idExam, session('idMember'));
                            ?>
                            <tr>
                                <td><?php echo $no++; ?></td>
                                <td>
                                    <table border="0">
                                        <tr>
                                            <td><button onclick="enterExam(<?php echo $data->idExam; ?>,'<?php echo $data->examType; ?>')" class="btn btn-primary"><i class="fa fa-sign-in" aria-hidden="true"></i></button></td>
                                        </tr>
                                    </table>
                                </td>
                                ...
                                <?php if($getExamCompletion->count() == 0): ?>
                                    <td><span class="badge badge-danger">Incomplete</span></td>
                                <?php else: ?>
                                    <?php
                                    $getScore = $db->getTotalExamScoreByIdExamAndIdMember($data->idExam, session('idMember'));
                                    ?>
                                    <td>
...
<script language="JavaScript">
    function enterExam(idExam, typeExam){
        location.href='/myCourse/enterClass/<?php echo $idCoursesClass; ?>/enterSession/<?php echo $idTopic; ?>/<?php echo $idSubTopic; ?>/enterExam/'+idExam+'/'+typeExam;
    }
</script>
