...
<div class="row">
    <div class="col-lg-12">
        ...
        <div class="card mb-3">
            ...
            <div class="card-body">
                <button onclick="location.href='<?php echo URL::to('/'); ?>/manageOnlineCourse/availableClass/manageOnlineClass/<?php echo $idCoursesClass; ?>/manageSession/<?php echo $idTopic; ?>/<?php echo $idSubTopic; ?>/manageAssignment/<?php echo $idAssignment; ?>/upload/evaluateAssignment'" class="btn btn-warning">Back</button>&nbsp;
                <br />
                <br />
                                ...
                                <td>
                                    ...
                                    <?php else: ?>
                                        <form>
                                            <div class="form-group">
                                                <div class="col-sm-6">
                                                    <button type="button" onclick="location.href='<?php echo URL::to('/').$getStudentAnswer->answerValue; ?>'" class="btn btn-success">Download Answer</button>
                                                </div>
                                            </div>
                                        </form>
                                        <br />
                            ...
                            <tr>
                                <td>
                                    <?php if($getAssignmentCompletion->isEvaluated == "0"): ?>
                                        ...
                                        <form method="post" action="<?php echo URL::to('/'); ?>/manageOnlineCourse/availableClass/manageOnlineClass/<?php echo $idCoursesClass; ?>/manageSession/<?php echo $idTopic; ?>/<?php echo $idSubTopic; ?>/manageAssignment/<?php echo $idAssignment; ?>/upload/evaluateAssignment/<?php echo $idMember; ?>/submitEvaluate" class="form-horizontal">
...
<script language="JavaScript">
    function finishEvaluation(){
        ...
        if(isConfirm){
            location.href="<?php echo URL::to('/'); ?>/manageOnlineCourse/availableClass/manageOnlineClass/<?php echo $idCoursesClass; ?>/manageSession/<?php echo $idTopic; ?>/<?php echo $idSubTopic; ?>/manageAssignment/<?php echo $idAssignment; ?>/upload/evaluateAssignment/<?php echo $idMember; ?>/finishEvaluation";
        }
    }
</script>
