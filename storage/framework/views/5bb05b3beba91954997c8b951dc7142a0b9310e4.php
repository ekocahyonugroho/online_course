        ...
        <div class="card mb-3">
            ...
            <div class="card-body">
                <div class="row">
                    <div class="col-lg-12">
                        <div class="alert alert-info">
                            This process is used to create an exam with multiple choice method. Means that students choose the best answer based on the question asked.
                        </div>
                    </div>
                </div>
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content panel-info">
            ...
            <div class="modal-body" id="myAddQuestionModalsBody">
                <form method="post" action="<?php echo URL::to('/'); ?>/manageOnlineCourse/availableClass/manageOnlineClass/<?php echo $idCoursesClass; ?>/manageSession/<?php echo $idTopic; ?>/<?php echo $idSubTopic; ?>/manageExam/<?php echo $idExam; ?>/written/editExam/submitNewQuestion" class="form-horizontal">
                    ...
                    <input type="hidden" name="typeExam" value="choices">
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content panel-info">
            ...
            <div class="modal-body" id="myEditQuestionModalsBody">
                <form method="post" action="<?php echo URL::to('/'); ?>/manageOnlineCourse/availableClass/manageOnlineClass/<?php echo $idCoursesClass; ?>/manageSession/<?php echo $idTopic; ?>/<?php echo $idSubTopic; ?>/manageExam/<?php echo $idExam; ?>/choices/editExam/submitEditQuestion" class="form-horizontal">
                    <input type="hidden" name="_token" value="<?php echo e(csrf_token()); ?>">
                    <input type="hidden" name="idCoursesClass" value="<?php echo $idCoursesClass; ?>">
                    <input type="hidden" name="idTopic" value="<?php echo $idTopic; ?>">
                    <input type="hidden" name="idSubTopic" value="<?php echo $idSubTopic; ?>">
...
<script language="JavaScript">
    ...
    function editQuestion(idQuestion){
        ...
        xmlhttpReq.open("POST", "<?php echo URL::to('/'); ?>/manageOnlineCourse/availableClass/manageOnlineClass/<?php echo $idCoursesClass; ?>/manageSession/<?php echo $idTopic; ?>/<?php echo $idSubTopic; ?>/manageExam/<?php echo $idExam; ?>/choices/editExam/previewEditQuestion", true);
    ...
    function deleteQuestion(idQuestion){
        ...
        if(isConfirm){
            location.href='<?php echo URL::to('/'); ?>/manageOnlineCourse/availableClass/manageOnlineClass/<?php echo $idCoursesClass; ?>/manageSession/<?php echo $idTopic; ?>/<?php echo $idSubTopic; ?>/manageExam/<?php echo $idExam; ?>/choices/editExam/deleteQuestion/'+idQuestion;
        }
    }
