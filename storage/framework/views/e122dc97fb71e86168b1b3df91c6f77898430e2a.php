...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top">
    <a class="navbar-brand" target="_blank" href="http://www.sbm.itb.ac.id/mba/jakarta"><img src="<?php echo URL::asset('/images/tk_low_logo.png'); ?>" alt="SBM ITB TK Low Logo" height="100" width="auto"></a>
    ...
    <div class="collapse navbar-collapse" id="navbarResponsive">
        <ul class="navbar-nav ml-auto">
            ...
            <?php if(empty(session('username'))): ?>
                <li class="nav-item">
                    <a class="nav-link" href="<?php echo URL::to('/'); ?>/login">Sign In</a>
                </li>
            <?php else: ?>
                <li class="nav-item">
                    <a class="nav-link" href="<?php echo URL::to('/'); ?>/logout">Logout</a>
                </li>
            <?php endif; ?>
            <li class="nav-item">
...
<div class="container" style="padding-top: 5%">
            ...
            <div class="panel panel-info">
                ...
                <div class="panel-body">
                    ...
                    <?php if(session()->has('status')): ?>
                        <?php if(session('status') == 'register_success'): ?>
                        ...
                        <?php elseif(session('status') == 'already_verified'): ?>
                            <div class="alert alert-warning">
                                <strong>!</strong> You already been verified. No action was taken.
                            </div>
                        <?php elseif(session('status') == 'reset_instruction'): ?>
                            <div class="alert alert-warning">
                        ...
                        <?php elseif(session('status') == 'link_expired'): ?>
    ...
    <div class="row">
    <?php $__currentLoopData = $available_course_data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index =>$available_courses): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <div class="col-lg-4 col-md-5 col-sm-6 portfolio-item">
                <div class="card h-100">
                    <a href="<?php echo URL::to('/').'/course/'.$available_courses->CourseCode.'-'.$available_courses->idCoursesClass.'/about'; ?>"><img class="card-img-top" src="<?php if ($available_courses->ThumbnailURLAddress == "") { echo 'http://placehold.it/700x400'; } else { echo $available_courses->ThumbnailURLAddress; } ?>" alt=""></a>
                    <div class="card-body">
                        <h4 class="card-title"><a href="<?php echo URL::to('/').'/course/'.$available_courses->CourseCode.'-'.$available_courses->idCoursesClass.'/about'; ?>"><?php echo $available_courses->nama_mata_kuliah_id; ?></a></h4>
                    ...
                    <div class="card-footer">
                        <center>
                            <p class="card-text">
                                Started On <?php echo date('F Y', strtotime($available_courses->OpenedStart)); ?>

                                <br />
                                <?php echo strtoupper($available_courses->OnlineProgramName); ?>

                                <br />
                                <b><?php echo $userInterface->showCourseClassPrice($available_courses->idCoursesClass); ?></b>
                            </p>
                        </center>
                    </div>
                </div>
