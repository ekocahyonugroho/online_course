                                ...
                                <td>
                                    <?php if(count($getStudentAnswer) == 0): ?>
                                        <?php if($getExamCompletion->count() == 0): ?>
                                            ...
                                            <?php else: ?>
                                                <form method="post" action="<?php echo URL::to('/'); ?>/myCourse/enterClass/<?php echo $idCoursesClass; ?>/enterSession/<?php echo $idTopic; ?>/<?php echo $idSubTopic; ?>/enterExam/<?php echo $idExam; ?>/written/<?php echo $question->idQuestion; ?>/submitExamAnswer">
...
<script language="JavaScript">
    function completeExam(){
        ...
        if(isConfirm){
            location.href='/myCourse/enterClass/<?php echo $idCoursesClass; ?>/enterSession/<?php echo $idTopic; ?>/<?php echo $idSubTopic; ?>/enterExam/<?php echo $idExam; ?>/written/completeExam';
        }
    }
</script>
