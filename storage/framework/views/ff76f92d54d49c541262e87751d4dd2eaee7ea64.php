...
<script language="JavaScript">
    function editQuestion(idQuestion){
        ...
        xmlhttpReq.open("POST", "<?php echo URL::to('/'); ?>/manageOnlineCourse/availableClass/manageOnlineClass/<?php echo $idCoursesClass; ?>/manageSession/<?php echo $idTopic; ?>/<?php echo $idSubTopic; ?>/manageAssignment/<?php echo $idAssignment; ?>/written/editAssignment/previewEditQuestion", true);
