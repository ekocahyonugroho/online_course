...
$completedStudents = $db->getAllAssignmentCompletionByIdAssignment($idAssignment)->get();
                    ...
                    <tbody>
                        <?php $__currentLoopData = $completedStudents; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <?php
                                ...
                                $getScore = $db->getTotalAssignmentScoreByIdAssignmentAndIdMember($idAssignment, $data->idMember);

                                if($getScore){
                                    $score = $getScore;
                                }

                                $studentCompletion = $db->getAssignmentCompletionByIdAssignmentAndIdMember($idAssignment, $data->idMember)->first();
                            ?>
                            <tr>
                                <td><?php echo $no++; ?></td>
                                <td>
...
<script language="JavaScript">
    function evaluateStudent(idMember){
        location.href="<?php echo URL::to('/'); ?>/manageOnlineCourse/availableClass/manageOnlineClass/<?php echo $idCoursesClass; ?>/manageSession/<?php echo $idTopic; ?>/<?php echo $idSubTopic; ?>/manageAssignment/<?php echo $idAssignment; ?>/<?php echo $typeAssignment; ?>/evaluateAssignment/"+idMember;
    }
</script>
