...
<div class="row">
    <div class="col-lg-12">
        ...
        <div class="card mb-3">
            ...
            <div class="card-body">
                <button onclick="location.href='<?php echo URL::to('/'); ?>/manageOnlineCourse/availableClass/manageOnlineClass/<?php echo $idCoursesClass; ?>/manageSession/<?php echo $idTopic; ?>/<?php echo $idSubTopic; ?>/manageAssignment/<?php echo $idAssignment; ?>/choices/evaluateAssignment'" class="btn btn-warning">Back</button>&nbsp;
                <br />
                <br />
                <table class="table table-bordered">
                    ...
                    <?php else: ?>
                        <?php $__currentLoopData = $dataQuestion; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $question): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                ...
                                <td>
                                    ...
                                    <?php else: ?>
                                        <form>
                                            <div class="form-group">
                                                <div class="col-sm-6">
                                                    Answer : <?php echo $db->getCoursesClassAssignmentChoiceValueByIdChoice($getStudentAnswer->answerValue)->first()->answerText; ?>
                            ...
                            <tr>
                                <td>
                                    <?php if($getAssignmentCompletion->isEvaluated == "0"): ?>
                                        <?php if(empty($getStudentAnswer->answerSuggestion)): ?>
                                            <form method="post" action="<?php echo URL::to('/'); ?>/manageOnlineCourse/availableClass/manageOnlineClass/<?php echo $idCoursesClass; ?>/manageSession/<?php echo $idTopic; ?>/<?php echo $idSubTopic; ?>/manageAssignment/<?php echo $idAssignment; ?>/choices/evaluateAssignment/<?php echo $idMember; ?>/submitEvaluate" class="form-horizontal">
                                                <input type="hidden" name="_token" value="<?php echo e(csrf_token()); ?>">
                                                <input type="hidden" name="idQuestion" value="<?php echo $question->idQuestion; ?>">
                                                <input type="hidden" name="score" value="<?php echo $getStudentAnswer->answerScore; ?>" />
                                                <div class="form-group">
...
<script language="JavaScript">
    function finishEvaluation(){
        ...
        if(isConfirm){
            location.href="<?php echo URL::to('/'); ?>/manageOnlineCourse/availableClass/manageOnlineClass/<?php echo $idCoursesClass; ?>/manageSession/<?php echo $idTopic; ?>/<?php echo $idSubTopic; ?>/manageAssignment/<?php echo $idAssignment; ?>/choices/evaluateAssignment/<?php echo $idMember; ?>/finishEvaluation";
        }
    }
</script>
