                                            ...
                                            <?php else: ?>
                                                <table class="table table-hovered">
                                                    <?php $__currentLoopData = $dataChoice; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $choice): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        <tr class="table-info">
                                                            <td width="8%">
                                                                <form action="<?php echo URL::to('/'); ?>/myCourse/enterClass/<?php echo $idCoursesClass; ?>/enterSession/<?php echo $idTopic; ?>/<?php echo $idSubTopic; ?>/enterExam/<?php echo $idExam; ?>/choices/<?php echo $question->idQuestion; ?>/submitExamAnswer" method="post">
...
<script language="JavaScript">
    function completeExam(){
        ...
        if(isConfirm){
            location.href='/myCourse/enterClass/<?php echo $idCoursesClass; ?>/enterSession/<?php echo $idTopic; ?>/<?php echo $idSubTopic; ?>/enterExam/<?php echo $idExam; ?>/choices/completeExam';
        }
    }
</script>
