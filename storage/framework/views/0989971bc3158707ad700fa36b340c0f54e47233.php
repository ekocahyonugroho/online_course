                ...
                <table class="table table-bordered">
                    ...
                    <tr>
                        <td>
                            ...
                            <?php else: ?>
                            <form method="post" enctype="multipart/form-data" action="<?php echo URL::to('/'); ?>/myCourse/enterClass/<?php echo $idCoursesClass; ?>/enterSession/<?php echo $idTopic; ?>/<?php echo $idSubTopic; ?>/enterExam/<?php echo $idExam; ?>/upload/<?php echo $question->idQuestion; ?>/submitExamAnswer">
...
<script language="JavaScript">
    function completeExam(){
        ...
        if(isConfirm){
            location.href='/myCourse/enterClass/<?php echo $idCoursesClass; ?>/enterSession/<?php echo $idTopic; ?>/<?php echo $idSubTopic; ?>/enterExam/<?php echo $idExam; ?>/upload/completeExam';
        }
    }
</script>
