...
<div class="row">
                ...
                <table class="table table-hovered">
                    ...
                    <?php else: ?>
                        <?php $__currentLoopData = $dataMaterial; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            ...
                            ?>
                            <tr>
                                <td><?php echo $faIcon; ?> <a href="<?php echo URL::to('/'); ?>/myCourse/enterClass/<?php echo $idCoursesClass; ?>/enterSession/<?php echo $idTopic; ?>/<?php echo $idSubTopic; ?>/showMaterial/<?php echo $data->idMaterial; ?>"><?php echo $data->titleMaterial; ?></a></td>
                            </tr>
    ...
    <div class="col-lg-9">
        ...
        <div class="card mb-3">
            ...
            <div class="card-body">
                <?php if(!empty($contentMaterial)): ?>
                    <?php echo $contentMaterial; ?>
