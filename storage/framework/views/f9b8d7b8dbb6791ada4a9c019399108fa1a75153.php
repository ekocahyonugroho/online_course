        ...
        <div class="card mb-3">
            ...
            <div class="card-body">
                <div class="row">
                    <div class="col-lg-12">
                        <div class="alert alert-info">
                            This process is used to create an assignment with uploading file method. Means that students read the question and upload any required files as the answer based on the question asked.
                        </div>
                    </div>
                </div>
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content panel-info">
            ...
            <div class="modal-body" id="myAddQuestionModalsBody">
                <form method="post" action="<?php echo URL::to('/'); ?>/manageOnlineCourse/availableClass/manageOnlineClass/<?php echo $idCoursesClass; ?>/manageSession/<?php echo $idTopic; ?>/<?php echo $idSubTopic; ?>/manageAssignment/<?php echo $idAssignment; ?>/upload/editAssignment/submitNewQuestion" class="form-horizontal">
                    ...
                    <input type="hidden" name="typeAssignment" value="upload">
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content panel-info">
            ...
            <div class="modal-body" id="myEditQuestionModalsBody">
                <form method="post" action="<?php echo URL::to('/'); ?>/manageOnlineCourse/availableClass/manageOnlineClass/<?php echo $idCoursesClass; ?>/manageSession/<?php echo $idTopic; ?>/<?php echo $idSubTopic; ?>/manageAssignment/<?php echo $idAssignment; ?>/upload/editAssignment/submitEditQuestion" class="form-horizontal">
                    <input type="hidden" name="_token" value="<?php echo e(csrf_token()); ?>">
                    <input type="hidden" name="idCoursesClass" value="<?php echo $idCoursesClass; ?>">
                    <input type="hidden" name="idTopic" value="<?php echo $idTopic; ?>">
                    <input type="hidden" name="idSubTopic" value="<?php echo $idSubTopic; ?>">
...
<script language="JavaScript">
    function editQuestion(idQuestion){
        ...
        xmlhttpReq.open("POST", "<?php echo URL::to('/'); ?>/manageOnlineCourse/availableClass/manageOnlineClass/<?php echo $idCoursesClass; ?>/manageSession/<?php echo $idTopic; ?>/<?php echo $idSubTopic; ?>/manageAssignment/<?php echo $idAssignment; ?>/upload/editAssignment/previewEditQuestion", true);
