    ...
    <div class="col-lg-12">
        ...
        <div class="card mb-3">
            ...
            <div class="card-body">
                ...
                <button onclick="showModals('myCreateAssignmentModals', 'Create Assignment')" class="btn btn-primary">Create Assignment</button>
            </div>
        </div>
    </div>
</div>
                ...
                <table class="table table-hovered">
                    ...
                    <?php else: ?>
                        <?php $__currentLoopData = $dataAssignment; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            ...
                            $getUnevaluatedAssignment = $db->getAssignmentCompletionByIdAssignment($data->idAssignment,'0');
                            ?>
                            <tr>
                                <td><?php echo $no++; ?></td>
                                <td>
                                    <table border="0">
                                        <tr>
                                            <td><button onclick="deleteAssignment(<?php echo $data->idAssignment; ?>,'<?php echo $data->assignmentType; ?>')" class="btn btn-danger"><i class="fa fa-trash" aria-hidden="true"></i></button></td>
                                            <td><button onclick="editAssignment(<?php echo $data->idAssignment; ?>,'<?php echo $data->assignmentType; ?>')" class="btn btn-warning"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></button></td>
                                            <td><button onclick="evaluateAssignment(<?php echo $data->idAssignment; ?>,'<?php echo $data->assignmentType; ?>')" class="btn btn-info"><?php echo $getUnevaluatedAssignment->count(); ?> Students Completed</button></td>
                                        </tr>
                                    </table>
                                </td>
...
<script language="JavaScript">
    function editAssignment(idAssignment,typeAssignment){
        location.href = '/manageOnlineCourse/availableClass/manageOnlineClass/<?php echo $idCoursesClass; ?>/manageSession/<?php echo $idTopic; ?>/<?php echo $idSubTopic; ?>/manageAssignment/'+idAssignment+'/'+typeAssignment+'/editAssignment';
    }

    function deleteAssignment(idAssignment,typeAssignment){
        var isConfirm = confirm('Are you sure to delete this Assignment?');
        if(isConfirm) {
            location.href = '/manageOnlineCourse/availableClass/manageOnlineClass/<?php echo $idCoursesClass; ?>/manageSession/<?php echo $idTopic; ?>/<?php echo $idSubTopic; ?>/manageAssignment/' + idAssignment + '/' + typeAssignment + '/deleteAssignment';
        }
    }

    function evaluateAssignment(idAssignment,typeAssignment){
        location.href = '/manageOnlineCourse/availableClass/manageOnlineClass/<?php echo $idCoursesClass; ?>/manageSession/<?php echo $idTopic; ?>/<?php echo $idSubTopic; ?>/manageAssignment/'+idAssignment+'/'+typeAssignment+'/evaluateAssignment';
    }
</script>
