...
<li class="nav-item" data-toggle="tooltip" data-placement="right" title="Link">
    <a class="nav-link" href="<?php echo URL::to('/'); ?>/manageOnlineCourse/availableClass/manageOnlineClass/<?php echo $idCoursesClass; ?>">
        <i class="fa fa-fw fa-link"></i>
        <span class="nav-link-text">Course Overview</span>
    </a>
</li>
<?php if($idAuthority == "1" OR $idAuthority == "2"): ?>
    <!-- <li class="nav-item" data-toggle="tooltip" data-placement="right" title="Link">
...
<li class="nav-item" data-toggle="tooltip" data-placement="right" title="Menu Levels">
    ...
    <ul class="sidenav-second-level collapse" id="collapseSessions">
        <li>
            <a href="<?php echo URL::to('/'); ?>/manageOnlineCourse/availableClass/manageOnlineClass/<?php echo $idCoursesClass; ?>/manageSession/addNewTopicForm">Add New Topic</a>
        </li>
                ...
                <?php if(!empty($dataSubTopic)): ?>
                    <li>
                        ...
                        <ul class="sidenav-third-level collapse" id="collapse<?php echo $session->idTopic; ?>">
                            <li>
                                <a href="<?php echo URL::to('/'); ?>/manageOnlineCourse/availableClass/manageOnlineClass/<?php echo $idCoursesClass; ?>/manageSession/<?php echo $session->idTopic; ?>">Add New Sub Topic</a>
                            </li>
                            <?php $__currentLoopData = $dataSubTopic; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $subTopic): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <li>
                                    <a href="<?php echo URL::to('/'); ?>/manageOnlineCourse/availableClass/manageOnlineClass/<?php echo $idCoursesClass; ?>/manageSession/<?php echo $session->idTopic; ?>/<?php echo $subTopic->idSubTopic; ?>"><?php echo $subTopic->subTopicName; ?></a>
                                </li>
...
<li class="nav-item" data-toggle="tooltip" data-placement="right" title="Link">
    <a class="nav-link" href="<?php echo URL::to('/'); ?>/manageOnlineCourse/availableClass/manageOnlineClass/<?php echo $idCoursesClass; ?>/viewEnrolledStudents">
        <i class="fa fa-fw fa-link"></i>
