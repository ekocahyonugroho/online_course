...
<div class="row">
    <div class="col-lg-2">
        ...
        <div class="card mb-3">
            ...
            <div class="card-body">
                <form name="activateOnlineClassForm" method="post" action="<?php echo URL::to('/'); ?>/ServerSide/ManageOnlineClass/ActivateOnlineClass">
                    <input type="hidden" name="_token" value="<?php echo e(csrf_token()); ?>">
                    <input type="hidden" name="idCoursesClass" value="<?php echo $idCoursesClass; ?>">
                    <?php if($dataOnlineClass->IsOpened == "1"): ?>
    ...
    <div class="card mb-3">
      ...
      <div class="card-body">
        <center><h3>OVERVIEW</h3></center>
          <?php if(empty($dataOnlineClass->CourseOverview)): ?>
              <div class="alert alert-danger">
                  <strong>!</strong> NO OVERVIEW YET
              </div>
          <?php else: ?>
              <?php echo $dataOnlineClass->CourseOverview; ?>
