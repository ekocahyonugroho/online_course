<li class="nav-item" data-toggle="tooltip" data-placement="right" title="Menu Levels">
  ...
  <ul class="sidenav-second-level collapse" id="collapseMembers">
    <li>
      <a href="{!! URL::to('/') !!}/manageMember/admin">Administrators</a>
    </li>
    <li>
      <a href="{!! URL::to('/') !!}/manageMember/lecturer">Lecturers</a>
    </li>
    <li>
      <a href="{!! URL::to('/') !!}/manageMember/student">Students</a>
    </li>
    <li>
      ...
      <ul class="sidenav-third-level collapse" id="collapseMembers2">
        <li>
          <a href="{!! URL::to('/') !!}/manageMember/public/waitingVerification">Waiting Verification</a>
        </li>
        <li>
          <a href="{!! URL::to('/') !!}/manageMember/public">Verified Members</a>
        </li>
      </ul>
    </li>
  </ul>
...
<li class="nav-item" data-toggle="tooltip" data-placement="right" title="Menu Levels">
  ...
  <ul class="sidenav-second-level collapse" id="collapseCourseClass">
    <li>
      <a href="{!! URL::to('/') !!}/manageOnlineCourse/manageClassProgram">Class Program</a>
    </li>
    <li>
      <a href="{!! URL::to('/') !!}/manageOnlineCourse/manageCourse">Courses</a>
    </li>
    <li>
      ...
      <ul class="sidenav-third-level collapse" id="collapseCourseClass2">
        <li>
          <a href="{!! URL::to('/') !!}/manageOnlineCourse/availableClass">Available Online Class</a>
        </li>
        <li>
