        ...
        <div class="card mb-3">
            ...
            <div class="card-body">
                <div class="row">
                    <div class="col-lg-12">
                        <div class="alert alert-info">
                            This process is used to create an exam with direct written method. Means that students should write and type the answer directly.
                        </div>
                    </div>
                </div>
        ...
        <div class="modal-content panel-info">
            ...
            <div class="modal-body" id="myAddQuestionModalsBody">
                <form method="post" action="{!! URL::to('/') !!}/manageOnlineCourse/availableClass/manageOnlineClass/{!! $idCoursesClass !!}/manageSession/{!! $idTopic !!}/{!! $idSubTopic !!}/manageExam/{!! $idExam !!}/written/editExam/submitNewQuestion" class="form-horizontal">
                    ...
                    <input type="hidden" name="typeExam" value="written">
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content panel-info">
            ...
            <div class="modal-body" id="myEditQuestionModalsBody">
                <form method="post" action="{!! URL::to('/') !!}/manageOnlineCourse/availableClass/manageOnlineClass/{!! $idCoursesClass !!}/manageSession/{!! $idTopic !!}/{!! $idSubTopic !!}/manageExam/{!! $idExam !!}/upload/editExam/submitEditQuestion" class="form-horizontal">
                    <input type="hidden" name="_token" value="{{ csrf_token() }}">
                    <input type="hidden" name="idCoursesClass" value="{!! $idCoursesClass !!}">
                    <input type="hidden" name="idTopic" value="{!! $idTopic !!}">
                    <input type="hidden" name="idSubTopic" value="{!! $idSubTopic !!}">
...
<script language="JavaScript">
    function editQuestion(idQuestion){
        ...
        xmlhttpReq.open("POST", "{!! URL::to('/') !!}/manageOnlineCourse/availableClass/manageOnlineClass/{!! $idCoursesClass !!}/manageSession/{!! $idTopic !!}/{!! $idSubTopic !!}/manageExam/{!! $idExam !!}/written/editExam/previewEditQuestion", true);
