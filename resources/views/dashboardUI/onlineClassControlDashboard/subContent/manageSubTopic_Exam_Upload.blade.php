    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content panel-info">
            ...
            <div class="modal-body" id="myAddQuestionModalsBody">
                <form method="post" action="{!! URL::to('/') !!}/manageOnlineCourse/availableClass/manageOnlineClass/{!! $idCoursesClass !!}/manageSession/{!! $idTopic !!}/{!! $idSubTopic !!}/manageExam/{!! $idExam !!}/upload/editExam/submitNewQuestion" class="form-horizontal">
...
<script language="JavaScript">
    function editQuestion(idQuestion){
        ...
        xmlhttpReq.open("POST", "{!! URL::to('/') !!}/manageOnlineCourse/availableClass/manageOnlineClass/{!! $idCoursesClass !!}/manageSession/{!! $idTopic !!}/{!! $idSubTopic !!}/manageExam/{!! $idExam !!}/upload/editExam/previewEditQuestion", true);
