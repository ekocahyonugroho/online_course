...
<div class="row">
    <div class="col-lg-12">
        ...
        <div class="card mb-3">
            ...
            <div class="card-body">
                <button onclick="location.href='{!! URL::to('/') !!}/manageOnlineCourse/availableClass/manageOnlineClass/{!! $idCoursesClass !!}/manageSession/{!! $idTopic !!}/{!! $idSubTopic !!}/manageExam/{!! $idExam !!}/choices/evaluateExam'" class="btn btn-warning">Back</button>&nbsp;
                <br />
                <br />
                                ...
                                <td>
                                    ...
                                    @else
                                        <form>
                                            <div class="form-group">
                                                <div class="col-sm-6">
                                                    Answer : {!! $db->getCoursesClassExamChoiceValueByIdChoice($getStudentAnswer->answerValue)->first()->answerText !!}
                                                </div>
                                            </div>
                                        </form>
                                        <br />
                                ...
                                <td>
                                    @if($getExamCompletion->isEvaluated == "0")
                                        @if(empty($getStudentAnswer->answerSuggestion))
                                            <form method="post" action="{!! URL::to('/') !!}/manageOnlineCourse/availableClass/manageOnlineClass/{!! $idCoursesClass !!}/manageSession/{!! $idTopic !!}/{!! $idSubTopic !!}/manageExam/{!! $idExam !!}/choices/evaluateExam/{!! $idMember !!}/submitEvaluate" class="form-horizontal">
...
<script language="JavaScript">
    function finishEvaluation(){
        ...
        if(isConfirm){
            location.href="{!! URL::to('/') !!}/manageOnlineCourse/availableClass/manageOnlineClass/{!! $idCoursesClass !!}/manageSession/{!! $idTopic !!}/{!! $idSubTopic !!}/manageExam/{!! $idExam !!}/choices/evaluateExam/{!! $idMember !!}/finishEvaluation";
        }
    }
</script>
