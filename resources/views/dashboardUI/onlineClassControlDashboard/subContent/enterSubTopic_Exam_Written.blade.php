                                ...
                                <td>
                                    @if(count($getStudentAnswer) == 0)
                                        @if($getExamCompletion->count() == 0)
                                            ...
                                            @else
                                                <form method="post" action="{!! URL::to('/') !!}/myCourse/enterClass/{!! $idCoursesClass !!}/enterSession/{!! $idTopic !!}/{!! $idSubTopic !!}/enterExam/{!! $idExam !!}/written/{!! $question->idQuestion !!}/submitExamAnswer">
...
<script language="JavaScript">
    function completeExam(){
        ...
        if(isConfirm){
            location.href='/myCourse/enterClass/{!! $idCoursesClass !!}/enterSession/{!! $idTopic !!}/{!! $idSubTopic !!}/enterExam/{!! $idExam !!}/written/completeExam';
        }
    }
</script>
