                                            ...
                                            @else
                                                <table class="table table-hovered">
                                                    @foreach($dataChoice AS $choice)
                                                        <tr class="table-info">
                                                            <td width="8%">
                                                                <form action="{!! URL::to('/') !!}/myCourse/enterClass/{!! $idCoursesClass !!}/enterSession/{!! $idTopic !!}/{!! $idSubTopic !!}/enterAssignment/{!! $idAssignment !!}/choices/{!! $question->idQuestion !!}/submitAssignmentAnswer" method="post">
...
<script language="JavaScript">
    function completeAssignment(){
        ...
        if(isConfirm){
            location.href='/myCourse/enterClass/{!! $idCoursesClass !!}/enterSession/{!! $idTopic !!}/{!! $idSubTopic !!}/enterAssignment/{!! $idAssignment !!}/choices/completeAssignment';
        }
    }
</script>
