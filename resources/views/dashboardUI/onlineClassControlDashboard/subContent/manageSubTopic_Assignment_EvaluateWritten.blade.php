...
<div class="row">
    <div class="col-lg-12">
        ...
        <div class="card mb-3">
            ...
            <div class="card-body">
                <button onclick="location.href='{!! URL::to('/') !!}/manageOnlineCourse/availableClass/manageOnlineClass/{!! $idCoursesClass !!}/manageSession/{!! $idTopic !!}/{!! $idSubTopic !!}/manageAssignment/{!! $idAssignment !!}/written/evaluateAssignment'" class="btn btn-warning">Back</button>&nbsp;
                <br />
                <br />
                                    ...
                                    @if($getAssignmentCompletion->isEvaluated == "0")
                                        @if(count($getStudentAnswer) == 1)
                                            @if($getStudentAnswer->isScored == '0')
                                                <form method="post" action="{!! URL::to('/') !!}/manageOnlineCourse/availableClass/manageOnlineClass/{!! $idCoursesClass !!}/manageSession/{!! $idTopic !!}/{!! $idSubTopic !!}/manageAssignment/{!! $idAssignment !!}/written/evaluateAssignment/{!! $idMember !!}/submitEvaluate" class="form-horizontal">
...
<script language="JavaScript">
    function finishEvaluation(){
        ...
        if(isConfirm){
            location.href="{!! URL::to('/') !!}/manageOnlineCourse/availableClass/manageOnlineClass/{!! $idCoursesClass !!}/manageSession/{!! $idTopic !!}/{!! $idSubTopic !!}/manageAssignment/{!! $idAssignment !!}/written/evaluateAssignment/{!! $idMember !!}/finishEvaluation";
        }
    }
</script>
