...
<div class="row">
    <div class="col-lg-12">
        ...
        <div class="card mb-3">
            ...
            <div class="card-body">
                <button onclick="location.href='{!! URL::to('/') !!}/manageOnlineCourse/availableClass/manageOnlineClass/{!! $idCoursesClass !!}/manageSession/{!! $idTopic !!}/{!! $idSubTopic !!}/manageExam/{!! $idExam !!}/written/evaluateExam'" class="btn btn-warning">Back</button>&nbsp;
                <br />
                <br />
...
<script language="JavaScript">
    function finishEvaluation(){
        ...
        if(isConfirm){
            location.href="{!! URL::to('/') !!}/manageOnlineCourse/availableClass/manageOnlineClass/{!! $idCoursesClass !!}/manageSession/{!! $idTopic !!}/{!! $idSubTopic !!}/manageExam/{!! $idExam !!}/written/evaluateExam/{!! $idMember !!}/finishEvaluation";
        }
    }
</script>
