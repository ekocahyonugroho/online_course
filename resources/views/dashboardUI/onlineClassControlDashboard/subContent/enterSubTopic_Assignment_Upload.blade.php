                                ...
                                <td>
                                    @if(count($getStudentAnswer) == 0)
                                        @if($getAssignmentCompletion->count() == 0)
                                            ...
                                            @else
                                                <form method="post" enctype="multipart/form-data" action="{!! URL::to('/') !!}/myCourse/enterClass/{!! $idCoursesClass !!}/enterSession/{!! $idTopic !!}/{!! $idSubTopic !!}/enterAssignment/{!! $idAssignment !!}/upload/{!! $question->idQuestion !!}/submitAssignmentAnswer">
...
<script language="JavaScript">
    function completeAssignment(){
        ...
        if(isConfirm){
            location.href='/myCourse/enterClass/{!! $idCoursesClass !!}/enterSession/{!! $idTopic !!}/{!! $idSubTopic !!}/enterAssignment/{!! $idAssignment !!}/upload/completeAssignment';
        }
    }
</script>
