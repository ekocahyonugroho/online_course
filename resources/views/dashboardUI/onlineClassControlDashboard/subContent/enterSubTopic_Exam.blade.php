                        ...
                        @foreach($dataExam AS $data)
                            ...
                            <tr>
                                ...
                                <td>
                                    <table border="0">
                                        <tr>
                                            <td><button onclick="enterExam({!! $data->idExam !!},'{!! $data->examType !!}')" class="btn btn-primary"><i class="fa fa-sign-in" aria-hidden="true"></i></button></td>
                                        </tr>
                                    </table>
                                </td>
                                <td>{!! $creatorName !!}</td>
...
<script language="JavaScript">
    function enterExam(idExam, typeExam){
        location.href='/myCourse/enterClass/{!! $idCoursesClass !!}/enterSession/{!! $idTopic !!}/{!! $idSubTopic !!}/enterExam/'+idExam+'/'+typeExam;
    }
</script>
