...
<div class="row">
    <div class="col-lg-12">
        ...
        <div class="card mb-3">
            ...
            <div class="card-body">
                <button onclick="location.href='{!! URL::to('/') !!}/manageOnlineCourse/availableClass/manageOnlineClass/{!! $idCoursesClass !!}/manageSession/{!! $idTopic !!}/{!! $idSubTopic !!}/manageAssignment/{!! $idAssignment !!}/choices/evaluateAssignment'" class="btn btn-warning">Back</button>&nbsp;
                <br />
                <br />
                                ...
                                <td>
                                    ...
                                    @else
                                        <form>
                                            <div class="form-group">
                                                <div class="col-sm-6">
                                                    Answer : {!! $db->getCoursesClassAssignmentChoiceValueByIdChoice($getStudentAnswer->answerValue)->first()->answerText !!}
                                                </div>
                                            </div>
                                        </form>
                                        <br />
                            ...
                            <tr>
                                <td>
                                    @if($getAssignmentCompletion->isEvaluated == "0")
                                        @if(empty($getStudentAnswer->answerSuggestion))
                                            <form method="post" action="{!! URL::to('/') !!}/manageOnlineCourse/availableClass/manageOnlineClass/{!! $idCoursesClass !!}/manageSession/{!! $idTopic !!}/{!! $idSubTopic !!}/manageAssignment/{!! $idAssignment !!}/choices/evaluateAssignment/{!! $idMember !!}/submitEvaluate" class="form-horizontal">
                                                <input type="hidden" name="_token" value="{{ csrf_token() }}">
                                                <input type="hidden" name="idQuestion" value="{!! $question->idQuestion !!}">
                                                <input type="hidden" name="score" value="{!! $getStudentAnswer->answerScore !!}" />
                                                <div class="form-group">
...
<script language="JavaScript">
    function finishEvaluation(){
        ...
        if(isConfirm){
            location.href="{!! URL::to('/') !!}/manageOnlineCourse/availableClass/manageOnlineClass/{!! $idCoursesClass !!}/manageSession/{!! $idTopic !!}/{!! $idSubTopic !!}/manageAssignment/{!! $idAssignment !!}/choices/evaluateAssignment/{!! $idMember !!}/finishEvaluation";
        }
    }
</script>
