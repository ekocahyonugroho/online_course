    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content panel-info">
            ...
            <div class="modal-body" id="myAddQuestionModalsBody">
                <form method="post" action="{!! URL::to('/') !!}/manageOnlineCourse/availableClass/manageOnlineClass/{!! $idCoursesClass !!}/manageSession/{!! $idTopic !!}/{!! $idSubTopic !!}/manageExam/{!! $idExam !!}/written/editExam/submitNewQuestion" class="form-horizontal">
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content panel-info">
            ...
            <div class="modal-body" id="myEditQuestionModalsBody">
                <form method="post" action="{!! URL::to('/') !!}/manageOnlineCourse/availableClass/manageOnlineClass/{!! $idCoursesClass !!}/manageSession/{!! $idTopic !!}/{!! $idSubTopic !!}/manageExam/{!! $idExam !!}/choices/editExam/submitEditQuestion" class="form-horizontal">
                    <input type="hidden" name="_token" value="{{ csrf_token() }}">
                    <input type="hidden" name="idCoursesClass" value="{!! $idCoursesClass !!}">
                    <input type="hidden" name="idTopic" value="{!! $idTopic !!}">
                    <input type="hidden" name="idSubTopic" value="{!! $idSubTopic !!}">
...
<script language="JavaScript">
    ...
    function editQuestion(idQuestion){
        ...
        xmlhttpReq.open("POST", "{!! URL::to('/') !!}/manageOnlineCourse/availableClass/manageOnlineClass/{!! $idCoursesClass !!}/manageSession/{!! $idTopic !!}/{!! $idSubTopic !!}/manageExam/{!! $idExam !!}/choices/editExam/previewEditQuestion", true);
    ...
    function deleteQuestion(idQuestion){
        ...
        if(isConfirm){
            location.href='{!! URL::to('/') !!}/manageOnlineCourse/availableClass/manageOnlineClass/{!! $idCoursesClass !!}/manageSession/{!! $idTopic !!}/{!! $idSubTopic !!}/manageExam/{!! $idExam !!}/choices/editExam/deleteQuestion/'+idQuestion;
        }
    }
