...
<div class="row">
    <div class="col-lg-12">
        <form method="post" action="{!! URL::to('/') !!}/ServerSide/ManageOnlineClass/addOnlineClassDescription/submit" class="form-horizontal">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-12">
                    <input type="text" value="{!! $dataOnlineClass->ThumbnailURLAddress !!}" name="thumbnailURL" placeholder="http://" class="form-control" />
                </div>
            </div>
            <div class="form-group">
                <label class="control-label col-sm-8" for="email">Opening Video URL Address :</label>
                <div class="col-sm-12">
                    <input type="text" value="{!! $dataOnlineClass->VideoURLDescription !!}" name="videoURL" placeholder="http://" class="form-control" />
                </div>
            </div>
            <div class="form-group">
                ...
                <div class="col-sm-12">
                    ...
                    <script>
                        ...
                        @if(!empty($dataOnlineClass->CourseDescription))
                            CKEDITOR.instances['courseDescription'].setData('{!! str_replace(array("\r\n", "\n\r", "\r", "\n"), "<br />",$dataOnlineClass->CourseDescription) !!}', {
                            callback: function() {
